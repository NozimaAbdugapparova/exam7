...
export default function AddRoomDrawer({ open, onClose, onSuccess }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE}/api/rooms/add/new`, {
        method: "POST",
        headers: {
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 shrink-0">
          <div>
            <h2 className="text-base font-semibold text-gray-800">Xona qo'shish</h2>
            <p className="text-xs text-gray-400 mt-0.5">Yangi xona ma'lumotlarini kiriting</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide px-6 py-5 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-800 placeholder-gray-400 outline-none transition focus:border-[#3d5af1] focus:bg-white focus:ring-2 focus:ring-[#3d5af1]/10"
            />
          </div>
